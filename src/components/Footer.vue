<template>
 <footer class="px-3 bg-dark">
  <div class="row text-light">
   <div class="col-12 py-5 col-lg-4">
    <div class="row">
     <div class="col-6">
      <img src="@/assets/index.png" />
      <p class="pt-4">
       Телефон поддержки: <br />
       <a class="h5" href="tel:+998 (71) 202 202 1">+998 (71) 202 202 1</a>
      </p>
     </div>
     <div class="col-6">
      <ul class="text-white">
       <li class="flex justify-start items-center pb-3">
        <svg
         class="rounded-pill"
     ...
     <div class="col-12">
      <div class="row">
       <div class="col-4">
        <a href="#">
         <img class="w-100" src="../assets/appstore.png" alt="" />
        </a>
       </div>
       <div class="col-4">
        <a href="#">
         <img class="w-100" src="../assets/googleplay.png" alt="" />
        </a>
       </div>
       <div class="col-4">
        <a href="#">
         <img class="w-100" src="../assets/app-gallery.svg" alt="" />
        </a>
       </div>
      </div>
     </div>
   ...
   <div class="col-12 py-5 col-lg-4">
    <h5 class="text-danger fw-bold pb-3">Информация</h5>
    <ul class="info">
     <li class="pb-3">
      <a href="#">О нас</a>
     </li>
     ...
     <li class="pb-3">
      <a href="#"> Бонусы и промокоды </a>
     </li>
     <li class="pb-3">
      <a href="#"> Условия рассрочки </a>
     </li>
     <li class="pb-3">
      <a href="#"> Сервисный центры </a>
     </li>
     <li class="pb-3">
    ...
    <h5 class="text-danger fw-bold pb-3 w-100">О нас</h5>
    <ul class="about">
     <li class="pb-3">
